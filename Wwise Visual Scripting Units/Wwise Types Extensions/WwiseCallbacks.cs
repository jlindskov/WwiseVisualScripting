...
[Inspectable][System.Serializable]
public class WwiseCallbacks : AK.Wwise.CallbackFlags
{
    //These types seem to be necessary. Grrrrr. 
    
    
    #if UNITY_EDITOR
		[UnityEditor.CustomPropertyDrawer(typeof(WwiseCallbacks))]
